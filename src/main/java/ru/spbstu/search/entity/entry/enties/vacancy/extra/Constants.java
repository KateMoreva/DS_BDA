...
public interface Constants {
    ...
    public static interface Currency {
        public static final IEntity<ru.spbstu.search.entity.entry.enties.vacancy.extra.Currency>
                CURRENCIES = ExtraInfoInitializer.getInstance().getCurrency();
        /**
         * Рубли.
         */
        public static final ru.spbstu.search.entity.entry.enties.vacancy.extra.Currency
    ...
    public static interface EducationLevel {
        public static final IEntity<ru.spbstu.search.entity.entry.enties.vacancy.extra.EducationLevel>
                EDUCATION_LEVELS = ExtraInfoInitializer.getInstance().getEducationLevel();
        /**
         * Высшее.
         */
        public static final ru.spbstu.search.entity.entry.enties.vacancy.extra.EducationLevel
    ...
    public static interface Employment {
        public static final IEntity<ru.spbstu.search.entity.entry.enties.vacancy.extra.Employment>
                EMPLOYMENTS = ExtraInfoInitializer.getInstance().getEmployment();
        /**
         * Полная занятость.
         */
        public static final ru.spbstu.search.entity.entry.enties.vacancy.extra.Employment
    ...
    public static interface Experience {
        public static final IEntity<ru.spbstu.search.entity.entry.enties.vacancy.extra.Experience>
                EXPERIENCES = ExtraInfoInitializer.getInstance().getExperience();
        /**
         * Нет опыта.
         */
        public static final ru.spbstu.search.entity.entry.enties.vacancy.extra.Experience
    ...
    public static interface Schedule {
        public static final IEntity<ru.spbstu.search.entity.entry.enties.vacancy.extra.Schedule>
                SCHEDULES = ExtraInfoInitializer.getInstance().getSchedule();
        /**
         * Полный день.
         */
        public static final ru.spbstu.search.entity.entry.enties.vacancy.extra.Schedule
    ...
    public static interface Label {
        public static final IEntity<ru.spbstu.search.entity.entry.enties.vacancy.extra.Label>
                LABELS = ExtraInfoInitializer.getInstance().getLabel();
        /**
         * Только с адресом.
         */
        public static final ru.spbstu.search.entity.entry.enties.vacancy.extra.Label
    ...
    public static interface LanguageLevel {
        public static final IEntity<ru.spbstu.search.entity.entry.enties.vacancy.extra.LanguageLevel>
                LANGUAGE_LEVELS = ExtraInfoInitializer.getInstance().getLanguageLevel();
        /**
         * Базовые знания.
         */
        public static final ru.spbstu.search.entity.entry.enties.vacancy.extra.LanguageLevel
    ...
    public static interface VacancyType {
        public static final IEntity<ru.spbstu.search.entity.entry.enties.vacancy.VacancyType>
                VACANCY_TYPES = ExtraInfoInitializer.getInstance().getVacancyType();
        /**
         * Открытая.
         */
        public static final ru.spbstu.search.entity.entry.enties.vacancy.VacancyType
    ...
    public static interface VacancySearchFields {
        public static final IEntity<ru.spbstu.search.fields.VacancySearchFields>
                VACANCY_SEARCH_FIELDS = ExtraInfoInitializer.getInstance().getVacancySearchFields();
        /**
         * В названии вакансии.
         */
        public static final ru.spbstu.search.fields.VacancySearchFields
    ...
    public static interface EmployerType {
        public static final IEntity<ru.spbstu.search.entity.entry.enties.vacancy.extra.employer.EmployerType>
                EMPLOYER_TYPES = ExtraInfoInitializer.getInstance().getEmployerType();
        /**
         * Прямой работодатель.
         */
        public static final ru.spbstu.search.entity.entry.enties.vacancy.extra.employer.EmployerType
    ...
    public static interface Order {
        public static final IEntity<ru.spbstu.search.entity.entry.enties.vacancy.extra.Order>
                ORDERS = ExtraInfoInitializer.getInstance().getOrder();
        /**
         * По дате.
         */
        public static final ru.spbstu.search.entity.entry.enties.vacancy.extra.Order
